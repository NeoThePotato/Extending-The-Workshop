...
namespace Templates
{
	...
	static class Units
	{
		...
		public static Unit invincibleArchdemon = new Unit("The Invincible Archdemon", 70, 3, 0f, 0f, 1f, Weapons.fieryGreatsword, Armors.towerShield, Armors.moltenArmor);
		public static Unit tyrantKingClone = new Unit("Clone of The Tyrant King", 60, 5, 0.3f, 0.2f, 1f, Weapons.tyrantGauntletsBootleg, Armors.nothing, Armors.kingSlayerArmor);
		public static Unit tyrantKing = new Unit("The Tyrant King", 150, 10, 0.4f, 0.3f, 1f, Weapons.tyrantGauntlets, Armors.nothing, Armors.godSlayerArmor);
	}
